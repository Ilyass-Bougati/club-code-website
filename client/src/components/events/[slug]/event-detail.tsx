            ...
            >
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="flex items-center gap-2 mb-2">
                  <Badge className="bg-blue-900 text-blue-200 dark:bg-blue-900 dark:text-blue-200" >
                    {event.eventType}
                  </Badge>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className={`font-medium ${isRegistrationAvailable ? 'text-green-600' : 'text-red-600'}`}>
