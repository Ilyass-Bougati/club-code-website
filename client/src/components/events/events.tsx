          ...
          >
            <Link href={`/events?id=${event.id}`}>
              ...
              <div className="h-48 w-full overflow-hidden relative rounded-t-2xl">
                ...
                <Badge className="absolute top-3 left-3 bg-blue-900 dtext-blue-200  dark:bg-blue-900 dark:text-blue-200">
                  {event.eventType}
                </Badge>
                {/* Overlay Learn More */}
              ...
              <CardContent className="text-sm text-muted-foreground space-y-2">
                ...
                <div className="flex items-center gap-2 my-4">
                  ...
                  <span className={event.registrationOpen ? "text-green-600" : "text-red-600"}>
