        ...
        >
          ...
          >
            {isRegistrationOpen ? (
              ...
              <div className="inline-flex items-center gap-3 md:px-12 px-8 md:py-6 py-4 bg-muted text-muted-foreground rounded-full font-bold text-lg opacity-70 cursor-not-allowed">
          ...
          >
            {isRegistrationOpen
              ...
              : "Registration will reopen soon. Stay tuned for updates."}
          </motion.p>
        </motion.div>
      </div>
    </section>
