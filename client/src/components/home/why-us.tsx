...
const WhyUs = () => {
  const leftFeatures = [
    ...
    },
    {
      title: "Career Growth",
      description:
        "Gain mentorship from seniors , and professionals to strengthen your  career path.",
  ...
  const rightFeatures = [
    ...
    },
    {
      ...
      description:
        "Work together on exciting ideas, share knowledge, and build solutions as a team.",
    ...
    },
    {
      ...
      description:
        "Be part of a community that encourages learning, and mutual support at every step.",
  ...
  return (
    <section
      id="why-us"
      className="relative isolate min-h-screen flex flex-col justify-center items-center py-16 overflow-hidden"
    >
          ...
          >
            ...
            >
              ...
              <span className="font-medium text-foreground">
                ocused on skill-building, collaboration, and real-world
                projects.
              </span>{" "}
              and real-world{" "}
              <span className="font-medium text-foreground font-serif">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          ...
          >
            {leftFeatures.map((feature, idx) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${feature.color} opacity-0 group-hover:opacity-20 rounded-2xl blur transition-opacity duration-300`}
                ></div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <motion.div className="w-48 h-48 relative" animate={floatAnimation}>
          ...
          >
            {rightFeatures.map((feature, idx) => (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-l ${feature.color} opacity-0 group-hover:opacity-20 rounded-2xl blur transition-opacity duration-300`}
                ></div>
                <div className="relative bg-muted  backdrop-blur-sm rounded-2xl p-6 border border-white/20 shadow-lg hover:shadow-2xl transition-all duration-300">
                  <div className="flex justify-end">
                    <div
                      className={`inline-flex p-3 rounded-xl bg-gradient-to-l ${feature.color} text-white mb-4 ml-auto `}
                    >
                      {feature.icon}
                    </div>
                  </div>
