...
const CreativeWhyUs = () => {
    const leftFeatures = [
        ...
        {
            title: "Career Growth",
            description: "Gain mentorship from seniors , and professionals to strengthen your  career path.",
    ...
    const rightFeatures = [
        ...
        },
        {
            ...
            description: "Work together on exciting ideas, share knowledge, and build solutions as a team.",
            icon: <Lightbulb className="w-5 h-5" />,
            color: "from-primary to-secondary"
        },
        {
            title: "Supportive Environment",
            description: "Be part of a community that encourages learning, and mutual support at every step.",
