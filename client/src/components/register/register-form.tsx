...
const schema = z.object({
  ...
  areaOfInterest: z.array(areaOfInterestSchema).nonempty(),
});
  ...
  return (
    <div className="container mt-10 px-4 mb-20">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-12">
        <Image src="/form.svg" alt="student" width={400} height={500} className="hidden md:block w-[400px] h-auto" />

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="w-full md:w-2xl">
                        ...
                        <FormControl>
                          <Select
                            onValueChange={(val) => {
                              ...
                              if (area) field.onChange([{ id: area.id, name: area.name }]);
                            }}
                          >
